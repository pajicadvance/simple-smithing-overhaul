...
public class ModConfig extends Config {
    ...
    public static class PortableItemRepair extends ConfigSection {
		...
		public ValidatedList<String> flintMaterialWhitelist = itemOrItemTagList(
	...
	public static class ItemDestructionPrevention extends ConfigSection {
		...
		public ValidatedList<String> allowList = itemOrItemTagList();
	}
    ...
    private static ValidatedList<String> itemOrItemTagList(String... defaults) {
        return new ValidatedString("", itemOrItemTagEntry()).toList(defaults);
    }
