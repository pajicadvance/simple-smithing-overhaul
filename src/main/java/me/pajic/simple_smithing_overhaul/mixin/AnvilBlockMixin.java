...
public abstract class AnvilBlockMixin extends FallingBlock {
    ...
    //~ if <26.1 'EnumProperty<Direction>' -> 'DirectionProperty'
    ...
    private static BlockState brokenState(BlockState original, @Local(argsOnly = true) BlockState blockState) {
    ...
    @Override
    //~ if <26.1 'InteractionResult' -> 'ItemInteractionResult'
