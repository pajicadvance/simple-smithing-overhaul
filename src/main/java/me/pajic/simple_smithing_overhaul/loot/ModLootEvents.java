    ...
    public static void init() {
        LootTableEvents.MODIFY.register((resourceKey, builder, lootTableSource, provider) -> {
            if (lootTableSource.isBuiltin()) {
                if (BuiltInLootTables.END_CITY_TREASURE.equals(resourceKey) && Main.CONFIG.enchantmentUpgrading.enableEnchantmentUpgrading()) {
                ...
                if (BuiltInLootTables.ANCIENT_CITY.equals(resourceKey) && Main.CONFIG.pinnacleEnchantment.enablePinnacleEnchantment()) {
                    builder.pool(LootPool.lootPool()
