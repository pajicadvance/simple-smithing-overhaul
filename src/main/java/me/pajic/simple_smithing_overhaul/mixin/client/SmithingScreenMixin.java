...
public abstract class SmithingScreenMixin extends ItemCombinerScreen<SmithingMenu> {
	...
	@Override protected void extractLabels(@NotNull GuiGraphicsExtractor graphics, int xm, int ym) {
        //~ if <26.1 'extractLabels' -> 'renderLabels'
		...
		if (
			...
			if (repairCost > 0) {
				...
				graphics.fill(x - 2, 67, imageWidth - 8, 79, 0x4F000000);
                //~ if <26.1 'graphics.text' -> 'graphics.drawString'
				graphics.text(font, component, x, 69, textColor);
			}
		}
		if (
